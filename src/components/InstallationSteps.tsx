...
export function InstallationSteps() {
  ...
  const copyInstructions = () => {
    const text = steps.map((step, i) => `${i + 1}. ${step.title}: ${step.description}`).join("\n");
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Follow these simple steps to install Cyber WhatsApp Pro manually. Takes less than 2 minutes!
          </p>
        </div>
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Icon */}
                <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-4 ${isLast ? "bg-emerald-100" : "bg-slate-100"}`}>
